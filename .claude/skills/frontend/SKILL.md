...
| Toolbar 圓鈕      | `rounded-full bg-stone-100 p-1.5 text-stone-500 transition-colors hover:bg-stone-200 hover:text-stone-600 active:bg-stone-300 active:text-stone-700` | Toolbar icon 按鈕  |
